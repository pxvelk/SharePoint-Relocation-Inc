  ...
  return (
    <div className="container-shell py-16 md:py-24">
      ...
      <p className="mt-5 max-w-4xl text-[#516985]">
        {lang === "en"
          ? "Our mission is to help Quebec organizations complete workplace transitions with precision, continuity, and confidence. We specialize in commercial relocation, renovation support, and office decommissioning where operational disruption must remain minimal and closeout outcomes are documented."
          : "Notre mission est d'aider les organisations du Québec à réussir leurs transitions d'espaces de travail avec rigueur, continuité et fiabilité. Nous sommes spécialisés en relocalisation commerciale, soutien aux rénovations et décommissionnement de bureaux avec documentation de fermeture."}
      </p>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        {(lang === "en"
          ? [
              ...
              "Responsible decommissioning and disposition support",
              "Reporting for asset destination and handover readiness",
            ]
          : [
              ...
              "Soutien en décommissionnement et disposition responsable",
              "Rapports de destination d'actifs et préparation à la remise",
            ]).map((point) => (
