...
export function ExecutionIndustrySection({ lang }: ExecutionIndustrySectionProps) {
  ...
  return (
    <section className="border-y border-[#d6dde8] bg-gradient-to-b from-white to-[#f5f8fd] py-16 md:py-24">
      <div className="container-shell">
        <div className="max-w-4xl">
          ...
          <p className="mt-4 text-lg text-[#4f6580]">
            {lang === "en"
              ? "PhasePoint Relocation delivers structured workplace transitions for renovation and relocation projects across Quebec. Every project is designed around minimal disruption, operational precision, and accountable execution."
              : "PhasePoint Relocation réalise des transitions de milieux de travail structurées pour les projets de rénovation et de relocalisation au Québec. Chaque mandat est conçu pour minimiser les perturbations, maintenir la précision opérationnelle et assurer une exécution responsable."}
          </p>
        </div>
          ...
          <article className="interactive-card rounded-2xl border border-[#d6dde8] bg-white p-6 md:p-7">
            <div className="mb-5 border-b border-[#e3eaf4] pb-4">
              ...
              <p className="mt-2 text-sm text-[#58708c]">
                {lang === "en"
                  ? "Best fit for organizations with strict continuity, building, and scheduling requirements."
                  : "Alignement optimal pour les organisations avec des exigences élevées en continuité, accès d'immeuble et échéanciers."}
              </p>
            </div>
        ...
        <div className="mt-8 rounded-2xl border border-[#d6dde8] bg-white px-6 py-5 md:flex md:items-center md:justify-between">
          <p className="max-w-3xl text-sm text-[#4f6580]">
            {lang === "en"
              ? "Trusted by teams that need structured planning, secure handling, and reliable execution with minimal operational downtime."
              : "Apprécié par les équipes qui ont besoin d'une planification structurée, d'une manutention sécurisée et d'une exécution fiable avec un minimum d'arrêt opérationnel."}
          </p>
